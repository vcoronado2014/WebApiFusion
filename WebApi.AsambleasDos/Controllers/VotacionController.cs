                    ...
                    if (triceles.Count == 1)
                    {
                        ...
                        if (tricel.Id >= 0)
                        {
                            ...
                            if (listaCorreos != null && listaCorreos.Count > 0)
                            {
                                ...
                                MailMessage mnsj = VCFramework.NegocioMySQL.Utiles.ConstruyeMensajeTricel(institucion.Id, institucion.Nombre, tricel.Nombre, listaCorreos, false, true, false, esCpas);
                ...
                else
                {
                    ...
                    if (respuesta >=0)
                    {
                        ...
                        if (listaCorreos != null && listaCorreos.Count > 0)
                        {
                            ...
                            //MailMessage mnsj = VCFramework.NegocioMySQL.Utiles.ConstruyeMensajeCrearProyecto(institucion.Nombre, tricel.Nombre, listaCorreos, false);
                            MailMessage mnsj = VCFramework.NegocioMySQL.Utiles.ConstruyeMensajeTricel(institucion.Id, institucion.Nombre, tricel.Nombre, listaCorreos, true, false, false, esCpas);
            ...
            try
            {
                ...
                if (inst != null && inst.Id > 0)
                {
                    ...
                    if (listaCorreos != null && listaCorreos.Count > 0)
                    {
                        ...
                        //MailMessage mnsj = VCFramework.NegocioMySQL.Utiles.ConstruyeMensajeCrearProyecto(institucion.Nombre, tricel.Nombre, listaCorreos, false);
                        MailMessage mnsj = VCFramework.NegocioMySQL.Utiles.ConstruyeMensajeTricel(institucion.Id, institucion.Nombre, inst.Nombre, listaCorreos, false, false, true, esCpas);
