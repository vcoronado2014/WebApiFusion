...
namespace VCFramework.NegocioMySQL
{
    public class ArchivosProyecto
    {
        ...
        public static int Insertar(VCFramework.Entidad.ArchivosProyecto entidad)
        {
            Factory fac = new Factory();
            return fac.Insertar<VCFramework.Entidad.ArchivosProyecto>(entidad, setCnsWebLun);
        }

        public static int Eliminar(VCFramework.Entidad.ArchivosProyecto entidad)
        {
            entidad.Eliminado = 1;
            Factory fac = new Factory();
            return fac.Update<VCFramework.Entidad.ArchivosProyecto>(entidad, setCnsWebLun);
        }
    }
}
